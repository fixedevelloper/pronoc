...
export default function AccountBalance() {
    ...
    return (
        <section className="p-6  shadow-2xl border border-white/50 bg-white/80  backdrop-blur-xl  bg-cardd rounded-2xl shadow-md space-y-6">
            <h1 className="text-2xl font-bold text-primary">Mon compte</h1>

            <p className="text-black-700 text-primary font-semibold">
